...
> Brand copy of `MockGpsShizuku` (original “虚拟定位 (Shizuku)”).
> Same features; only launcher name and `applicationId` differ. Both can be installed together.
>
> - Launcher name: `阿米 虚拟定位` (Ami Mock GPS)
> - applicationId: `com.ami.mockgps`
>
...
### 1. Install the APK
Build output: `AmiMockGps/app/build/outputs/apk/debug/app-debug.apk`
...
- Developer options → Select mock location app → “阿米 虚拟定位”
- Skip ① ②; go straight to ③ ④
...
```
AmiMockGps/app/src/main/java/com/mockgps/shizuku/
...
- **Fix**:
  ...
  2. `adb shell cmd appops get com.ami.mockgps android:mock_location` should print `MOCK_LOCATION: allow`
